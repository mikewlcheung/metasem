...
Another useful functions are \code{meta()} and \code{reml()}. They conduct fixed-, random-, and mixed-effects univariate and multivariate meta-analysis. The followings are some examples.
