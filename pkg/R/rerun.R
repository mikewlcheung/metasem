rerun <- function(object, ...) {
  if (!is.element(class(object)[1], c("wls", "tssem1FEM", "tssem1REM", "meta", "meta3ML", "reml", "tssem1FEM.cluster", "wls.cluster")))
    stop("\"object\" must be an object of neither class \"meta\", \"meta3ML\", \"wls\", \"reml\", \"tssem1FEM\", \"tssem1REM\", \"tssem1FEM.cluster\" or \"wls.cluster\".")
